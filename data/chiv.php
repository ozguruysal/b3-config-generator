...
$server = array (
    ...
    'rcon_port' => array (
            'formtype'   => 'text',
            'title'      => _('Rcon Port:'),
            'tooltip'    => _("Enter your game server's rcon (admin) port. (see 'RConPort' in section '[AOC.AOCRCon]' of your PCServer-UDKGame.ini game server config file)"),
            'default'    => '27960'
    ),
    'rcon_password' => array (
            'formtype'   => 'text',
            'title'      => _('Rcon Password:'),
            'tooltip'    => _('Enter your rcon password. (see AdminPassword in your game server config file)'),
            'default'    => 'MYrCOnPaSS'
    )
);
